      ...
      <div class="w-full px-4 py-12 flex flex-col items-center">
        ...
        <div class="flex flex-col items-center gap-4 z-10">
          <button
            ...
            class="relative overflow-hidden px-8 py-4 text-lg font-bold rounded-2xl bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 transition-all transform hover:scale-105 shadow-xl cursor-pointer"
          >
            <span class="flex items-center gap-3 text-gray-900">
          ...
          <button
            ...
            class="px-6 py-3 text-gray-300 hover:text-white border-2 border-gray-700 hover:border-yellow-400 rounded-xl transition-all duration-300 cursor-pointer active:scale-95"
          >
    ...
    <section class="py-16 bg-gray-900 text-white text-center">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto px-4">
        <div class="p-6 bg-gray-800 rounded-lg shadow">
          <LucideSearch class="w-10 h-10 mx-auto text-yellow-400" />
          <h3 class="text-xl font-semibold mt-4">Búsqueda Avanzada</h3>
          <p class="opacity-80 mt-2">Filtra cartas por nombre, rareza y número.</p>
        </div>
        <div class="p-6 bg-gray-800 rounded-lg shadow">
          <LucideBookOpen class="w-10 h-10 mx-auto text-yellow-400" />
          <h3 class="text-xl font-semibold mt-4">Colecciones Completas</h3>
          <p class="opacity-80 mt-2">Explora todas las colecciones de TCG.</p>
        </div>
        <div class="p-6 bg-gray-800 rounded-lg shadow">
          <LucideStar class="w-10 h-10 mx-auto text-yellow-400" />
          <h3 class="text-xl font-semibold mt-4">Favoritos</h3>
          <p class="opacity-80 mt-2">Guarda tus cartas preferidas en una lista.</p>
        </div>
      </div>
    </section>
  </div>
...
import { Search, X, LucideSearch, LucideBookOpen, LucideStar } from "lucide-vue-next";
